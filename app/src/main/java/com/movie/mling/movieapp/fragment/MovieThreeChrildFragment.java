...
import com.movie.mling.movieapp.adapter.MovieThreeBannerListAdapter;
 ...
 * $DESE$
 */
public class MovieThreeChrildFragment extends BaseFragment implements MovieNewListFragmentView {
    public YRecycleview yrecycle_view;
    private MovieNewListFragmentPresenter mMovieListFragmentPresenter;
    private MovieThreeBannerListAdapter mAdapter;
    private String url;
    ...
    public static MovieThreeChrildFragment newInstance(String url, String keytype, String uid, String isgood, String orderby, String bannerKeytype) {
        ...
        MovieThreeChrildFragment fragment = new MovieThreeChrildFragment();
    ...
    protected void setListener() {
        ...
        mAdapter = new MovieThreeBannerListAdapter(getActivity());
    ...
    public void excuteSuccessCallBackBanner(MovieBannerBean userVo) {
        mMovieListFragmentPresenter.getMovieDataList(userVo, url);
    }
}
