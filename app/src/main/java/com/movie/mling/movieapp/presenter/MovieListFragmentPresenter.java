...
public class MovieListFragmentPresenter {
    private MovieListFragmentView mMovieListFragmentView;

    public MovieListFragmentPresenter(MovieListFragmentView mMovieListFragmentView) {
    ...
    public void getMovieCollectList(String url) {
        mMovieListFragmentView.showProgress();
        HttpUtil.post(Constants.BASE_URL + Constants.APP_USER_FAV_LIST, mMovieListFragmentView.getParamenters(), new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                mMovieListFragmentView.showProgress();
