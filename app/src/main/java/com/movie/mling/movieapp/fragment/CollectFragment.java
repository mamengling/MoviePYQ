 ...
 * $DESE$
 */
public class CollectFragment extends BaseFragment implements MovieListFragmentView {
    ...
    public static CollectFragment newInstance(String url, String keytype, String uid, String isgood) {
    ...
    protected void setListener() {
        ...
        yrecycle.setRefreshAndLoadMoreListener(new YRecycleview.OnRefreshAndLoadMoreListener() {
            ...
            public void onRefresh() {
                intHandler = 101;
                intNumberPage = 0;
                mMovieListFragmentPresenter.getMovieCollectList(url);
            }
