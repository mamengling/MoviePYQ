...
import com.movie.mling.movieapp.adapter.ActorListCollectAdapater;
...
public class ActorCollectFragment extends BaseFragment implements ActorFragmentView, View.OnClickListener {
    ...
    private ActorListCollectAdapater mAdapter;
    private String type;
    ...
    public static ActorCollectFragment newInstance(String url, String token, String uuid, String type) {
        Bundle args = new Bundle();
        args.putString("url", url);
        args.putString("token", token);
        args.putString("uuid", uuid);
        args.putString("type", type);
        ActorCollectFragment fragment = new ActorCollectFragment();
...
//        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        ...
        mAdapter = new ActorListCollectAdapater(getActivity());
