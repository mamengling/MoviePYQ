...
public class ActorListCollectAdapater extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ActorListCollectAdapater(Context mContext) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (mList.get(position).getId() == 0) {
            ...
            ((ViewHolder) holder).itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    constmOnItemOnclickListener.clickItem(((ViewHolder) holder).itemView, position, 0, 0, mList.get(position).getPid() + "");
                }
            });
        }
    }
