 ...
 * $DESE$
 */
public class MovieThreeBannerListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieThreeBannerListAdapter(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.xml_item_movie_list_time, parent, false);
        ...
        if (mList.get(position).getViewType() == 1) {
            ...
            ((ViewHolderBanner) holder).normal_view_pager.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(int positionChild) {
                    constmOnItemOnclickListener.clickItem(((ViewHolderBanner) holder).itemView, position, positionChild, 1, mList.get(position).getListBannaer().get(positionChild).getLinks());
                }
            });
